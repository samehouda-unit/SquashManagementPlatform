                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              contentPadding: EdgeInsetsDirectional.fromSTEB(
                                  20.0, 24.0, 0.0, 24.0),
                              suffixIcon: _model
                                      .txtPlayerNameController!.text.isNotEmpty
                                  ? InkWell(
                                      onTap: () async {
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    contentPadding:
                                        EdgeInsetsDirectional.fromSTEB(
                                            20.0, 24.0, 0.0, 24.0),
                                    suffixIcon: _model.txtDateOfBirthController!
                                            .text.isNotEmpty
                                        ? InkWell(
                                            onTap: () async {
                                              _model.txtDateOfBirthController
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                _model.apiResultp5y =
                                  ...
                                  playerBio: _model.txtPlayerBioController.text,
                                );
                                if ((_model.apiResultp5y?.succeeded ?? true)) {
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        content:
                                            Text('Error while adding Player'),
                                        actions: [
                                          TextButton(
                                            onPressed: () => Navigator.pop(
                                                alertDialogContext),
