...
import 'edit_tournament_event4th_widget.dart' show EditTournamentEvent4thWidget;
...
class EditTournamentEvent4thModel
    extends FlutterFlowModel<EditTournamentEvent4thWidget> {
  ...
  // Stores action output result for [Backend Call - API (editPlanEventAPI)] action in Button widget.
