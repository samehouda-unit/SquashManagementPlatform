...
import 'create_tournament_match3rd_model.dart';
export 'create_tournament_match3rd_model.dart';
...
class _CreateTournamentMatch3rdWidgetState
    extends State<CreateTournamentMatch3rdWidget> {
  late CreateTournamentMatch3rdModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateTournamentMatch3rdModel());

    _model.txtMatchTimeController ??= TextEditingController();
                                                                  ...
                                                                  : List.generate(
                                                                      ...
                                                                      (index) =>
                                                                          random_data.randomInteger(
                                                                              0,
                                                                              0))),
                                                              optionLabels: (SquashManagementAPIGroupGroup.populatePlanEventsAPICall
                                                                                  .nameList(
                                                                                lstEventsPopulatePlanEventsAPIResponse.jsonBody,
                                                                              ) !=
                                                                              null &&
                                                                  ...
                                                                  child: FutureBuilder<
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return FlutterFlowDropDown<
                                                                          int>(
                                                                        controller: _model
                                                                            .lstPlayer1ValueController ??= FormFieldController<
                                                                                int>(
                                                                            null),
                                                                        options: List<
                                                                            int>.from((SquashManagementAPIGroupGroup.populatePlanPlayersAPICall.idList(
                                                                  ...
                                                                  child: FutureBuilder<
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return FlutterFlowDropDown<
                                                                          int>(
                                                                        controller: _model
                                                                            .lstPlayer2ValueController ??= FormFieldController<
                                                                                int>(
                                                                            null),
                                                                        options: List<
                                                                            int>.from((SquashManagementAPIGroupGroup.populatePlanPlayersAPICall.idList(
                                                ...
                                                onPressed: () async {
                                                  ...
                                                  _model.createMatchResponse =
                                                    ...
                                                    eventId:
                                                        _model.lstEventsValue,
                                                    player1Id:
                                                        _model.lstPlayer1Value,
                                                    player2Id:
                                                        _model.lstPlayer2Value,
                                                  );
                                                  if ((_model
                                                          .createMatchResponse
                                                          ?.succeeded ??
