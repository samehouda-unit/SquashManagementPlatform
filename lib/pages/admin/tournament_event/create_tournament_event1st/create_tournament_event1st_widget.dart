...
import 'create_tournament_event1st_model.dart';
...
class _CreateTournamentEvent1stWidgetState
    extends State<CreateTournamentEvent1stWidget> {
  late CreateTournamentEvent1stModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateTournamentEvent1stModel());
