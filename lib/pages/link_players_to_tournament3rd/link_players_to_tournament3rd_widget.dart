...
import 'link_players_to_tournament3rd_model.dart';
export 'link_players_to_tournament3rd_model.dart';
...
class LinkPlayersToTournament3rdWidget extends StatefulWidget {
  ...
  final int? paramTournamentPlanStage;
  final String? paramTournamentPlanGender;
...
class _LinkPlayersToTournament3rdWidgetState
    extends State<LinkPlayersToTournament3rdWidget> {
  late LinkPlayersToTournament3rdModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LinkPlayersToTournament3rdModel());
                                        ...
                                        children: [
                                          FutureBuilder<ApiCallResponse>(
                                            future: SquashManagementAPIGroupGroup
                                                ...
                                                .call(
                                              stage:
                                                  'eq.${widget.paramTournamentPlanStage?.toString()}',
                                              gender:
                                                  'eq.${widget.paramTournamentPlanGender}',
                                            ),
                                            builder: (context, snapshot) {
                                              ...
                                              final clubsListViewPopulatePlayerByStageAndGenderResponse =
                                                  snapshot.data!;
                                              return Builder(
                                                builder: (context) {
                                                  final players =
                                                      SquashManagementAPIGroupGroup
                                                              .populatePlayerByStageAndGenderCall
                                                              .players(
                                                                clubsListViewPopulatePlayerByStageAndGenderResponse
                                                                    .jsonBody,
                                                              )
                                                              ?.map((e) => e)
                                                              .toList()
                                                                              ...
                                                                              SnackBar(
                                                                                content: Text(
                                                                                  '${getJsonField(
                                                                                    playersItem,
                                                                                    r'''$.name''',
                                                                                  ).toString()} is added to ${widget.paramTournamentPlanName}',
                                                                                  style: TextStyle(
                                                                                    color: FlutterFlowTheme.of(context).primaryText,
                                                                                  ),
                                                                                ),
