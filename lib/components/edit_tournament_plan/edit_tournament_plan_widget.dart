...
import 'edit_tournament_plan_model.dart';
export 'edit_tournament_plan_model.dart';
...
class EditTournamentPlanWidget extends StatefulWidget {
  ...
  @override
  State<EditTournamentPlanWidget> createState() =>
      _EditTournamentPlanWidgetState();
}

class _EditTournamentPlanWidgetState extends State<EditTournamentPlanWidget>
    with TickerProviderStateMixin {
  late EditTournamentPlanModel _model;
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            return FlutterFlowDropDown<int>(
                                              ...
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'x9v2h7zj' /* Player Stage */,
                                              ),
                                              searchHintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '2vnjxpas' /* Select player stage */,
                                              ),
                                              icon: Icon(
                                                Icons
                                        ...
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              ...
                                              if (_model.lsGenderValue ==
                                                  null) {
                                                return;
                                              }
                                              if (_model.lstStagesValue ==
                                                  null) {
                                                return;
                                              }
                                              _model.updateTPlanQuery =
                                                  await SquashManagementAPIGroupGroup
                                                      .editTournamentPlanAPICall
                                                      .call(
                                                uuid: widget.paramPlanUuid,
                                                name: _model
                                                    .txtTournamentPlanNameController
                                                    .text,
                                                location:
                                              ...
                                              if ((_model.updateTPlanQuery
                                                ...
                                                ScaffoldMessenger.of(context)
                                                  ...
                                                  SnackBar(
                                                    content: Text(
                                                      'Tournament Plan has been updated successfully',
                                                      style: TextStyle(
                                                        color:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                ...
                                                ScaffoldMessenger.of(context)
                                                  ...
                                                  SnackBar(
                                                    content: Text(
                                                      'Error while updating tournament plan',
                                                      style: TextStyle(
                                                        color:
                                                            FlutterFlowTheme.of(
                                                                    context)
