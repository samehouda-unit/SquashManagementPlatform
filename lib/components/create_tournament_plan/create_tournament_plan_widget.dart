...
import 'create_tournament_plan_model.dart';
...
class _CreateTournamentPlanWidgetState extends State<CreateTournamentPlanWidget>
    with TickerProviderStateMixin {
  late CreateTournamentPlanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateTournamentPlanModel());
