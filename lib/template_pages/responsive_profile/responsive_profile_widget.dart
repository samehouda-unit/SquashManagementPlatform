...
import 'responsive_profile_model.dart';
...
class _ResponsiveProfileWidgetState extends State<ResponsiveProfileWidget>
    with TickerProviderStateMixin {
  late ResponsiveProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ResponsiveProfileModel());
