                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            '7ts6qpp5' /* Let's get started by filling o... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .labelLarge,
                                        ),
                                              ...
                                              children: [
                                                TextSpan(
                                                  text: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'zjakv0xd' /* Already have an account?  */,
                                                  ),
                                                  style: TextStyle(),
                                                ),
                                                TextSpan(
